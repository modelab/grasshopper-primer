...
![IMAGE](images/1-6-4/04A_edge-neighbors.png)
...
![IMAGE](images/1-6-4/04B_face-neighbors.png)
...
![IMAGE](images/1-6-4/04C_vertex-neighbors.png)
...
{% else %}
>Example files that accompany this section: [Download](../../appendix/A-2/gh-files/1.6.4_element addon.gh)
{% endif %}
...
|02.| **Element\*/Primitive/Icosohedron** - Drag and drop the **Icosohedron** component onto the canvas|![IMAGE](images/1-6-4/icosohedron.png)|
...
|06.| **Element\*/Data/Face Neighbors** - Drag and drop the **Face Neighbors** component onto the canvas| ![IMAGE](images/1-6-4/face-neighbors.png)|
|07.| Connect the Mesh (M) output of the **Icosohedron** component to the Mesh (M) input of the **Face Neighbors** component.|||

![IMAGE](images/1-6-4/exercise_01.png)
...
|11.| **Math/Operators/Subtraction** - Drag and drop a **Subtraction** component onto the canvas|![IMAGE](images/1-6-4/subtraction.png)|
...
|13.| **Sets/Tree/Merge** - Drag and drop a **Merge** component onto the canvas|![IMAGE](images/1-6-4/merge.png)|
...
|15.| **Curve/Analysis/Evaluate Curve** - Drag and drop an **Evaluate Curve** component onto the canvas|![IMAGE](images/1-6-4/evaluate-curve.png)
...
![IMAGE](images/1-6-4/exercise_02.png)


||||
|--|--|--|
|19.| **Sets/Tree/Trim Tree** - Drag and drop a **Trim Tree** component onto the canvas|![IMAGE](images/1-6-4/trim-tree.png)|
...
|21.| **Curve/Spline/Polyline** - Drag and drop a **Polyline** component onto the canvas|![IMAGE](images/1-6-4/polyline.png)|
...
|24.| **Element\*/Transform/Mesh Frame** - Drag and drop a **Mesh Frame** component onto the canvas.|![IMAGE](images/1-6-4/mesh-frame.png)
...
![IMAGE](images/1-6-4/exercise_03.png)
![IMAGE](images/1-6-4/exercise_04.png)

||||
|--|--|--|
|28.| **Element\*/Utility/Mesh Combine and Clean** - Drag and drop a **Mesh Combine and Clean** component on the canvas|![IMAGE](images/1-6-4/combine-and-clean.png)|
...
|31.| **Element\*/Transform/Mesh Thicken** - Drag and drop a **Mesh Thicken** component onto the canvas|![IMAGE](images/1-6-4/mesh-thicken.png)|
|32.| Connect the Mesh (M) output of **Combine and Clean** to the Mesh (M) input of **Mesh Thicken**||
|33.| **Element\*/Subdivide/Catmull Clark Subdivision** - Drag and drop a **Catmull Clark Subdivision** component onto the canvas|![IMAGE](images/1-6-4/catmull-clark.png)
|34.| Connect the Mesh (M) output of **Mesh Thicken** to the Mesh (M) input of the **Catmull Clark Subdivision** component|||

![IMAGE](images/1-6-4/exercise_05.png)
![IMAGE](images/1-6-4/exercise_06.png)
...
||||
|--|--|--|
|35.| **Params/Geometry/Point** - Drag and drop a **Point** parameter onto the canvas|![IMAGE](images/1-6-4/point.png)|
...
|37.| **Mesh/Analysis/Deconstruct Mesh** - Drag and drop a **Deconstruct Mesh** component onto the canvas|![IMAGE](images/1-6-4/deconstruct-mesh.png)|
...
|39.| **Vector/Point/Distance** - Drag and drop a **Distance** component onto the canvas|![IMAGE](images/1-6-4/distance.png)|
...
|45.| **Maths/Domain/Construct Domain** - Drag and drop a **Construct Domain** component onto the canvas|![IMAGE](images/1-6-4/construct-domain.png)
...
|43.| Right click the Type (T) input of the **Thicken** component, select "Set Integer" and enter a value of 1 <br><blockquote>You can also enable the PerVertex Data by using a **Boolean Toggle** component set to True.</blockquote>|||

![IMAGE](images/1-6-4/exercise_07.png)
![IMAGE](images/1-6-4/exercise_08.png)
--
![IMAGE](images/1-6-4/exercise_full.png)

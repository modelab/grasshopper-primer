...
![IMAGE](images/1-6-7/01_half-edge.png)
>1. Half-Edge
2. Face
3. Vertex
4. Next
...
![IMAGE](images/1-6-7/02_analyse-components.png)
...
![IMAGE](images/1-6-7/03_data-components.png)
>1. Data Visualizer
2. Edge Neighbors
3. Face Neighbors
4. Vertex Neighbors
...
![IMAGE](images/1-6-7/04A_edge-neighbors.png)
...
![IMAGE](images/1-6-7/04B_face-neighbors.png)
...
![IMAGE](images/1-6-7/04C_vertex-neighbors.png)
...
![IMAGE](images/1-6-7/05_primitives.png)
>1. Dodecahedron
2. Tetrahedron
3. Octahedron
4. Tetrahedron
...
![IMAGE](images/1-6-7/06_smooth.png)
...
![IMAGE](images/1-6-7/07_subdivide.png)
>1. Catmull Clark subdivision
2. Constant Quad subdivision

####1.6.7.7 Transform

![IMAGE](images/1-6-7/08_transform-components.png)
>1. Mesh Windown
2. Mesh Frame
3. Mesh Thicken
4. Mesh Offset
...
![IMAGE](images/1-6-7/09_transform-examples.png)
>1. Mesh Window
2. Mesh Frame
...
{% else %}
>Example files that accompany this section: [Download](../../appendix/A-2/gh-files/1.6.7_element addon.gh)
{% endif %}
...
|02.| **Element\*/Primitive/Icosohedron** - Drag and drop the **Icosohedron** component onto the canvas|![IMAGE](images/1-6-7/icosohedron.png)|
...
|06.| **Element\*/Data/Face Neighbors** - Drag and drop the **Face Neighbors** component onto the canvas| ![IMAGE](images/1-6-7/face-neighbors.png)|
|07.| Connect the Mesh (M) output of the **Icosohedron** component to the Mesh (M) input of the **Face Neighbors** component.|||

![IMAGE](images/1-6-7/exercise_01.png)
...
|11.| **Math/Operators/Subtraction** - Drag and drop a **Subtraction** component onto the canvas|![IMAGE](images/1-6-7/subtraction.png)|
...
|13.| **Sets/Tree/Merge** - Drag and drop a **Merge** component onto the canvas|![IMAGE](images/1-6-7/merge.png)|
...
|15.| **Curve/Analysis/Evaluate Curve** - Drag and drop an **Evaluate Curve** component onto the canvas|![IMAGE](images/1-6-7/evaluate-curve.png)
...
![IMAGE](images/1-6-7/exercise_02.png)


||||
|--|--|--|
|19.| **Sets/Tree/Trim Tree** - Drag and drop a **Trim Tree** component onto the canvas|![IMAGE](images/1-6-7/trim-tree.png)|
...
|21.| **Curve/Spline/Polyline** - Drag and drop a **Polyline** component onto the canvas|![IMAGE](images/1-6-7/polyline.png)|
...
|24.| **Element\*/Transform/Mesh Frame** - Drag and drop a **Mesh Frame** component onto the canvas.|![IMAGE](images/1-6-7/mesh-frame.png)
...
![IMAGE](images/1-6-7/exercise_03.png)
![IMAGE](images/1-6-7/exercise_04.png)

||||
|--|--|--|
|28.| **Element\*/Utility/Mesh Combine and Clean** - Drag and drop a **Mesh Combine and Clean** component on the canvas|![IMAGE](images/1-6-7/combine-and-clean.png)|
...
|31.| **Element\*/Transform/Mesh Thicken** - Drag and drop a **Mesh Thicken** component onto the canvas|![IMAGE](images/1-6-7/mesh-thicken.png)|
|32.| Connect the Mesh (M) output of **Combine and Clean** to the Mesh (M) input of **Mesh Thicken**||
|33.| **Element\*/Subdivide/Catmull Clark Subdivision** - Drag and drop a **Catmull Clark Subdivision** component onto the canvas|![IMAGE](images/1-6-7/catmull-clark.png)
|34.| Connect the Mesh (M) output of **Mesh Thicken** to the Mesh (M) input of the **Catmull Clark Subdivision** component|||

![IMAGE](images/1-6-7/exercise_05.png)
![IMAGE](images/1-6-7/exercise_06.png)
...
||||
|--|--|--|
|35.| **Params/Geometry/Point** - Drag and drop a **Point** parameter onto the canvas|![IMAGE](images/1-6-7/point.png)|
...
|37.| **Mesh/Analysis/Deconstruct Mesh** - Drag and drop a **Deconstruct Mesh** component onto the canvas|![IMAGE](images/1-6-7/deconstruct-mesh.png)|
...
|39.| **Vector/Point/Distance** - Drag and drop a **Distance** component onto the canvas|![IMAGE](images/1-6-7/distance.png)|
...
|45.| **Maths/Domain/Construct Domain** - Drag and drop a **Construct Domain** component onto the canvas|![IMAGE](images/1-6-7/construct-domain.png)

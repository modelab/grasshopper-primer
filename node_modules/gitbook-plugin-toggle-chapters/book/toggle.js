  ...
  gitbook.events.bind("page.change", function() {
    ...
    $chapters.each(function(){
        ...
        if ($num_sub_chapters > 0) {
                $(this).children('a').before("<a href=# onclick=\"toggle_list($(this))\" style=\"padding:10px;float:left;margin-right:-10px\" class=\"dropdown_closed\"><i class=\"fa fa-caret-right\"></i></a>");
        }
        $sub_chapters.each(function(){
            ...
            if ($num_sub_sub_chapters > 0) {
                ...
                $(this).children('a').before("<a href=# onclick=\"toggle_list($(this))\" style=\"padding-left:5px;padding-right:5px;float:left;margin-left:auto;margin-right:auto\" class=\"dropdown_closed\"><i class=\"fa fa-caret-right\"></i></a>");
            } else {
